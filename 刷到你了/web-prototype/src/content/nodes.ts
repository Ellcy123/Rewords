...
export const NODES: VideoNode[] = [
  ...
  node('W200', 'wedding', '@婚礼事故实录', '新娘活下来了', '这一次，新娘活下来了', '空调师傅踩上梯子修正承重扣，婚礼得以继续。', '师傅修好了灯架，伴娘却举起了手机。', 11,
    beats([0, '这一次，新娘活下来了'], [1, '师傅踩上已有的梯子'], [4, '承重扣装反了', '补上一根安全链'], [7, '婚礼继续！'], [9, '@首席伴娘 发布了新视频']), 'main', 'saved-bride', { onCompleteUnlock: 'W300' }),
  node('W300', 'wedding', '@首席伴娘', '婚礼当天私会维修工？', '新娘婚礼当天私会维修工？', '伴娘把感谢救命的握手剪成暧昧偷拍视频，婚礼取消。', '新娘活着，婚礼死了。', 13,
    beats([0, '新娘婚礼当天私会维修工？'], [1, '新郎举起偷拍视频质问'], [5, '“她把前后都剪掉了！”'], [8, '“有证据吗？”'], [10, '新娘活着，婚礼死了']), 'main', 'rumor-cut', { selectableItemIds: ['recorder', 'technician'] }),
