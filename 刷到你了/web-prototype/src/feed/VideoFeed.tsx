...
export function VideoFeed({ nodes, index, onIndexChange, locked = false, onProduct, onGift, onComments, likedNodeIds = [], favoritedNodeIds = [], onLike, onFavorite, onViewed }: Props) {
